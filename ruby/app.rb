...
module Isuconp
  class App < Sinatra::Base
    ...
    get '/' do
      ...
      comment_results = db.query("select t1.post_id, t1.comment, t2.account_name from comments t1 inner join users t2 on t1.user_id = t2.id where t1.post_id in (#{posts.map{|post| post[:id]}.join(',')})")
